...
> Источник: [https://dev.vk.ru/ru/mini-apps/development/testing](https://dev.vk.ru/ru/mini-apps/development/testing)
Вы можете управлять [группами тестировщиков](mini-apps/settings/test-groups) мини-приложения c помощью методов API.

:::note
**Важно!** Методы для управления группами тестировщиков используются с [сервисным ключом доступа мини-приложения](mini-apps/settings/development/keys#Сервисный%20ключ) и могут быть вызваны только на сервере.
:::
