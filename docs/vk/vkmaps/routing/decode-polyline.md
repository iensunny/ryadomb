# VK Карты | Сервисы маршрутизации | Построение маршрута | Декодирование ломаной маршрута

> Источник: [https://dev.vk.ru/ru/vkmaps/routing/decode-polyline](https://dev.vk.ru/ru/vkmaps/routing/decode-polyline)
<!-- vk-sdk/vkmaps/routing/decode-polyline -->
