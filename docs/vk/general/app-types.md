# О приложениях | Типы приложений ВКонтакте

> Источник: [https://dev.vk.ru/ru/general/app-types](https://dev.vk.ru/ru/general/app-types)
<!-- ---
title: 'О приложениях | Типы приложений ВКонтакте'
is_hidden: false
